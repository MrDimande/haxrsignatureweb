...
<#
  Cleanup Phase1A accidental probe guests on CLONE only (names/emails known).
  Does not touch production. Prints counts only.
#>
...
Write-Host "Clone DB password (cleanup phase1a probe guests)." -ForegroundColor Yellow
...
& node scripts/pr0-preview/cleanup-phase1a-probe-guests.mjs
