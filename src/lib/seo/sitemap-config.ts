...
> = {
  ...
  ferramentas: { priority: 0.92, changeFrequency: "weekly", tier: "service" },
  portfolio: { priority: 0.88, changeFrequency: "monthly", tier: "content" },
  experiencias: { priority: 0.85, changeFrequency: "monthly", tier: "demo" },
  faq: { priority: 0.78, changeFrequency: "monthly", tier: "content" },
  guias: { priority: 0.76, changeFrequency: "monthly", tier: "conversion" },
  forPros: { priority: 0.72, changeFrequency: "monthly", tier: "conversion" },
  submitWedding: { priority: 0.74, changeFrequency: "monthly", tier: "content" },
  haxrConcierge: { priority: 0.88, changeFrequency: "weekly", tier: "service" },
