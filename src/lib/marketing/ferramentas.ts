...
export const ferramentasCatalog: readonly FerramentaItem[] = [
  ...
  },
  {
    ...
    description: "Estime garrafas de vinho, whisky, cerveja, champanhe, salgados e bolo para casamentos em Moçambique.",
    href: "/tools/calculadora-bebidas-catering",
    image: "/images/tools/budget-tracker-bg.png",
    tier: "planeamento",
    includedIn: "Gratuito para Noivos",
    cta: "Calcular bebidas",
  },
  {
    id: "wedding-timeline",
    title: "Cronograma do Grande Dia",
    description: "Timeline minuto a minuto dos preparativos ao corte do bolo e festa, com exportação para WhatsApp e PDF.",
    href: "/tools/cronograma-casamento",
    image: "/images/tools/concierge-bg.png",
    tier: "planeamento",
    includedIn: "Gratuito para Noivos & Assessoras",
    cta: "Gerar cronograma",
  },
  {
    id: "floor-plan",
    title: "Simulador de Disposição de Mesas & Layout de Salão",
    description: "Calcule a área necessária em m², mesas redondas ou imperiais, pista de dança e estações de buffet.",
    href: "/tools/simulador-layout-salao",
    image: "/images/tools/guest-list-bg.png",
    tier: "planeamento",
    includedIn: "Gratuito para Noivos & Decoradores",
    cta: "Simular layout",
  },
  {
