...
export const portfolioArchive: PortfolioArchiveItem[] = [
  {
    ...
    category: "Casamento",
    service: "Web-Convite HAXR · Edição Legado",
  ...
  },
  {
    ...
    category: "Noivado",
    service: "Save the Date · Edição Legado",
...
export const invitationOccasions = [
  ...
  { id: "celebracao", label: "Outros Eventos" },
] as const;

export type InvitationOccasionId = (typeof invitationOccasions)[number]["id"];

/** Pacotes e preços — portfólio HAXR Signature (págs. 5–6) */
export const invitationPackages = [
  // Casamento & Lobolo
  {
    ...
    name: "Prólogo",
    tier: "Edicional I",
    subtitle: "A essência pura do primeiro encontro.",
    desc: "Desenhado para quem deseja uma introdução poética e imediata — sem ruído, com tipografia impecável e presença digital irrepreensível.",
    price: 7999,
    priceLabel: "7.999 MT",
    features: [
      ...
      "RSVP Directo (confirmação instantânea)",
  ...
  },
  {
    ...
    name: "Elo",
    tier: "Edicional II",
    subtitle: "A ponte viva entre a expectativa e a memória.",
    desc: "Amplia a narrativa do casal com curadoria fotográfica pre-wedding, orientação de vestuário e acolhimento colaborativo dos convidados.",
    price: 15999,
    priceLabel: "15.999 MT",
    includesNote: "A expansão do Prólogo, introduzindo:",
    features: [
      "Design e composição personalizada HAXR",
      "Sessão Fotográfica Pre-Wedding (3 obras)",
      ...
      "Plus Memories (galeria até 150 convidados)",
      "QR Code de acesso para o recinto",
    ],
    occasions: ["casamento"],
    featured: true,
  },
  {
    ...
    name: "Legado",
    tier: "Alta-Costura",
    subtitle: "Criado para viver antes, durante e perpetuar-se depois.",
    desc: "A expressão máxima do Atelier. Um ecossistema completo que unifica o anúncio prévio, a navegação em tempo real no recinto e o acervo pós-evento.",
    price: 25000,
    priceLabel: "25.000 MT",
    includesNote: "A transcensão do Elo, integrando:",
    features: [
      ...
      "Find Your Seat (pesquisa instantânea de mesa via QR Code)",
      "Plus Memories Ilimitado & Áudio das Felicitações",
      "Credenciação por QR Code individual de alta segurança",
  ...
  // Noivado
  {
    id: "noivado-essencial",
    name: "O Prelúdio",
    tier: "Classic",
    subtitle: "A elegância concisa para anunciar o compromisso.",
    desc: "A primeira nota da vossa melodia. Uma página de alta curadoria, desenhada para anunciar o noivado com impacto visual e funcionalidade imaculada.",
    price: 5999,
    priceLabel: "5.999 MT",
    features: [
      "Gestão fluida de RSVP",
      "Ambiente sonoro imersivo",
      "Contador dinâmico para o dia",
      "Geolocalização via Google Maps",
      "Cápsula fotográfica (até 3 retratos)",
      "Design responsivo e com assinatura",
      "Ativo digital para redes e WhatsApp",
    ],
    occasions: ["noivado"],
    featured: false,
  },
  {
    ...
    name: "A Transição",
    tier: "Signature",
    subtitle: "A narrativa que liga o sim aos preparativos.",
    desc: "A união visionária entre o anúncio do noivado e o Save the Date. Uma jornada visual expansiva que introduz os convidados ao vosso universo estético.",
    price: 12999,
    priceLabel: "12.999 MT",
    includesNote: "Evoluindo o Prelúdio, com:",
    features: [
      "Experiência Save the Date integrada",
      "Galeria visual expansiva",
      "Módulo elegante para presentes",
      "Timeline e programa detalhado",
      "Controlo inteligente de lotação e acompanhantes",
      "Suporte dedicado HAXR Signature",
    ],
    occasions: ["noivado"],
    featured: false,
  },
  // Corporativo
  {
    id: "corporativo-custom",
    name: "A Marca",
    tier: "Bespoke",
    subtitle: "O novo paradigma do prestígio institucional.",
    desc: "Engenharia digital de alta gama para galas, conferências e lançamentos. Uma infraestrutura segura que eleva a perceção de marca e automatiza a gestão de acessos VIP.",
    price: null,
    priceLabel: "Pedir Cotação",
    features: [
      "Contacte a nossa linha Executiva WhatsApp (+258 87 088 3428) para uma proposta à medida.",
      "Ecossistema fechado com acessos cifrados",
      "RSVP Corporativo com fluxos inteligentes",
      "Credenciação expressa via QR Code dinâmico",
      "Mapeamento VIP e gestão de protocolo",
      "UI/UX alinhado ao brandbook da instituição",
      "Analytics em tempo real sobre confirmações",
    ],
  ...
  // Outros Eventos
  {
    id: "aniversario-essencial",
    name: "A Celebração",
    tier: "Classic",
    subtitle: "Marcos pessoais com uma assinatura inconfundível.",
    desc: "Para aniversários que exigem mais que um convite genérico. Uma interface focada, elegante e pronta a receber os seus convidados com uma experiência premium.",
    price: 5999,
    priceLabel: "5.999 MT",
    features: [
      "Receção digital de convidados (RSVP)",
      "Curadoria musical ambiente",
      "Contagem decrescente elegante",
      "Integração perfeita de mapas",
      "Cápsula de retratos do celebrante",
      "Convite otimizado para partilha mobile",
    ],
    occasions: ["celebracao"],
    featured: false,
  },
  {
    id: "aniversario-completo",
    name: "O Jubileu",
    tier: "Signature",
    subtitle: "A narrativa expansiva da sua história.",
    desc: "A expressão máxima para comemorações de grande escala. Uma plataforma interativa que imerge os convidados no seu percurso e centraliza toda a coordenação do evento.",
    price: 10999,
    priceLabel: "10.999 MT",
    includesNote: "A evolução da Celebração, adicionando:",
    features: [
      "Abertura em motion com Save the Date",
      "Exposição visual (galeria de 15 momentos)",
      "Cronograma interativo e dress code",
      "Vault digital para presentes e contribuições",
      "Guestbook: Mural interativo de dedicatórias",
    ],
    occasions: ["celebracao"],
    featured: false,
  },
  {
    ...
    name: "A Conquista",
    tier: "Bespoke",
    subtitle: "A consagração de um legado académico.",
    desc: "A dignidade que o seu mérito exige. Uma coordenação de excelência entre a cerimónia oficial e a recepção, desenhada para partilhar o triunfo com absoluta distinção.",
    price: 11999,
    priceLabel: "11.999 MT",
    features: [
      "Gestão de presenças multi-evento (RSVP)",
      "Banda sonora de receção",
      "Contagem decrescente para a outorga",
      "Mapas para múltiplos locais (Cerimónia/Copo d'Água)",
      "Módulo de tributo (Presentes/Contribuições)",
      "Galeria fotográfica de percurso",
      "Programa detalhado dos atos académicos",
      "Filtro inteligente de acompanhantes",
    ],
    occasions: ["celebracao"],
    featured: false,
  },
...
export const invitationComparison = [
  { service: "Web-Convite digital interactivo", prologo: "included", elo: "included", legado: "included" },
  { service: "Design com Direcção Visual HAXR", prologo: "included", elo: "included", legado: "included" },
  { service: "Mapa de localização (Maps & Waze)", prologo: "included", elo: "included", legado: "included" },
  { service: "Abertura sonora & música de fundo", prologo: "included", elo: "included", legado: "included" },
  { service: "Contagem decrescente dinâmica", prologo: "included", elo: "included", legado: "included" },
  { service: "Confirmação de presença (RSVP)", prologo: "included", elo: "included", legado: "included" },
  { service: "Save the Date em vídeo", prologo: "included", elo: "included", legado: "included" },
  { service: "Galeria de fotografias editorial", prologo: "included", elo: "included", legado: "included" },
  { service: "Sessão Pre-Wedding curada", prologo: "none", elo: "included", legado: "included" },
  { service: "Guia de Dress Code & Presentes", prologo: "optional", elo: "included", legado: "included" },
  { service: "Lembretes automáticos aos convidados", prologo: "none", elo: "included", legado: "included" },
  { service: "Plus Memories (galeria colaborativa)", prologo: "optional", elo: "included", legado: "included" },
  { service: "QR Code de acesso ao recinto", prologo: "none", elo: "included", legado: "included" },
  { service: "Find Your Seat (localizador de mesas)", prologo: "none", elo: "none", legado: "included" },
  { service: "Direcção de Arte de Alta-Costura Sob Medida", prologo: "none", elo: "none", legado: "included" },
  { service: "Vídeo Pre-Wedding cinematográfico", prologo: "none", elo: "none", legado: "included" },
  { service: "Plus Memories com áudio de dedicatórias", prologo: "none", elo: "none", legado: "included" },
  { service: "Credenciação digital individual por QR Code", prologo: "none", elo: "none", legado: "included" },
  { service: "Acompanhamento e curadoria dedicada", prologo: "optional", elo: "optional", legado: "included" },
] as const;
...
export const invitationFaqs = [
  ...
  },
  {
    ...
    a: "O Prólogo inclui até 2 rondas de alteração. O Elo inclui até 4. O Legado tem acompanhamento e curadoria contínua definida em proposta, conforme a complexidade do projecto.",
  },
  {
    q: "O convite funciona em todos os dispositivos?",
    a: "Sim. Cada convite é optimizado para telemóvel em primeiro lugar — responsivo em tablet e desktop, sem perder identidade nem fluidez.",
  },
  {
    q: "Como funciona o pagamento?",
    a: "As condições são apresentadas na proposta de cada projecto. A produção inicia após confirmação do pagamento inicial e envio das informações necessárias.",
  },
] as const;
